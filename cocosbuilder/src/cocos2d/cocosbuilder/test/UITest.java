package cocos2d.cocosbuilder.test;
...
import cocos2d.cocosbuilder.test.GdxTest;
...
//		window.row();
	...
	public void render () {
		...
		Gdx.gl.glViewport(Gdx.graphics.getWidth()/4, Gdx.graphics.getHeight()/4, Gdx.graphics.getWidth()/2, Gdx.graphics.getHeight()/2);
